...
def testPairings2():
    ...
    registerPlayer("Applejack")
    registerPlayer("Pinkie Pie")
    registerPlayer("Banthy")
    registerPlayer("Tiny Tim")
    registerPlayer("Island Girl")
    registerPlayer("Johnny D")
    standings = playerStandings()
    ...
    correct_pairs = set([frozenset([id1, id3]), frozenset([id2, id4]), frozenset([id5, id7]), frozenset([id6, id8])])
...
if __name__ == '__main__':
    ...
    testReportMatches()
    testPairings()  # test against four players
    testPairings2() # test against eight players
